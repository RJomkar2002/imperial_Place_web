<%-- 
    Document   : armerchant
    Created on : 30 Sep, 2023, 3:11:30 PM
    Author     : 91982
--%>
    ...
    <body>
      ...
      <a href="adminDashboard.jsp"><input type="button" value="Dashboard" id="stage" name="Dash"></a>
       ...
       <table class="table table-striped">
        ...
        int f=0;
        ResultSet rs=st.executeQuery("select * from merreg where mflag=0");
        while(rs.next())
        {
            int p=rs.getInt(1);
            out.println("<tr>");
                    ...
                    out.println("<td>" +rs.getString(10));
                     out.println("<td>" +rs.getString(11));
                      out.println("<td>" +rs.getString(12));
                        ...
                        out.println("<td> <a href=Approvem.jsp?id="+p+">Approve</a>");
                         out.println("<td>  <a href=Rejectm.jsp?id="+p+">Reject</a>");
        }
