...
try
{
    ...
    String q="select cname,email,mobno from custreg where email="+p+"" ;
...
<form method="post" action="cfeedbackinsert.jsp" onsubmit="return validate()"> 
...
<div class="row">
  ...
  <div class="bottom">        
     <div class="col-sm-6">
        ...
        <div class="col-sm-8">
      <a href="customerDashboard.jsp"><input type="button" value="Back" id="stage"></a>
