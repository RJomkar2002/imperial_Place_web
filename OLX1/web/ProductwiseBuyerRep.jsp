...
text-decoration:none;
    ...
    <body>
        <form action="ProductwiseBuyerRep.jsp">
        <div align="center">
...
<% 
        ...
        Statement st=con.createStatement();
         String q="select distinct(category)from buynow";
        out.println();
...
//                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/olx","root","");
//                Statement st=con.createStatement();
//                String q="select email from buynow where category="+cat+"";
//                out.println();
//                ResultSet rs=st.executeQuery(q);
//                rs.next();
       ...
       <%
          ...
          //out.print(mname);
           try
           {
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/olx","root","");
                Statement st=con.createStatement();
                //String q="select * from custreg where email="+email+"";
                String q="select cid,name,padd,email,mobno from buynow where category="+cat+"";
                out.println();
                ResultSet rs=st.executeQuery(q);
                while(rs.next())
                {
