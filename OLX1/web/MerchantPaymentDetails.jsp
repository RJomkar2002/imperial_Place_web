<%-- 
    Document   : MerchantPaymentDetails
    Created on : 24 Mar, 2023, 11:50:14 AM
...
text-decoration:none;
    ...
    <body>
        <form action="MerchantPaymentDetails.jsp">
        <div align="center">
...
//         String q="select distinct(mname) from merreg";
//        out.println();
...
//                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/olx","root","");
//                Statement st=con.createStatement();
//                String q="select mid from merreg where mname="+a+"";
//                out.println();
//                ResultSet rs=st.executeQuery(q);
//                rs.next();
//                mid=rs.getInt(1);
...
<table class="table table-striped">
       ...
       <%
           ...
           try
           {
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/olx","root","");
                Statement st=con.createStatement();
                String q="select * from buynow where status=0";
                out.println();
                ResultSet rs=st.executeQuery(q);
                while(rs.next())
                {
                    ...
                    out.println("<td>"+rs.getInt(18));
                    int i=rs.getInt(19);
                    out.println("<td><a href=PayToMerchant.jsp?id="+p+"&mid="+i+">Pay Now</a></td>");
