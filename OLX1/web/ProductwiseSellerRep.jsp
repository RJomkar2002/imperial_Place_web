...
text-decoration:none;
    ...
    <body>
        <form action="ProductwiseSellerRep.jsp">
        <div align="center">
...
<% 
        ...
        Statement st=con.createStatement();
         String q="select distinct(category) from postadd";
        out.println();
...
<%
          ...
          //out.print(cat);
           try
           {
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/olx","root","");
                Statement st=con.createStatement();
                String q="select mname from postadd where category="+cat+"";
                out.println();
                ResultSet rs=st.executeQuery(q);
                rs.next();
       ...
       <%
          ...
          // out.print(mname);
           ...
           try
           {
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/olx","root","");
                Statement st=con.createStatement();
                String q="select * from merreg where mname="+mname+"";
                out.println();
                ResultSet rs=st.executeQuery(q);
                while(rs.next())
                {
